...
urlpatterns = [
    ...
    # Additional Leave URLs
    path('leave/additional/', views.add_additional_leave, name='add_additional_leave'),
    path('leave/additional/approve/<int:id>/', views.approve_additional_leave, name='approve_additional_leave'),
    path('leave/additional/reject/<int:id>/', views.reject_additional_leave, name='reject_additional_leave'),
]